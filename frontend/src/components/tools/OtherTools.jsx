    ...
    <div className="tool-container">
      <div className="tool-panel">
        <div className="panel-header">
          ...
          <div className="panel-actions">
            <button className="btn-secondary" onClick={handlePaste}>Paste</button>
          </div>
        </div>
        <div className="panel-body">
          <textarea
        ...
        <div className="panel-footer">
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <label style={{ fontSize: '13px', color: '#6b7280' }}>Questions:</label>
            <select 
              value={questionCount} 
...
export function ConvertPDF() {
  ...
  const handleConvert = () => {
    ...
    setIsProcessing(true);
    setTimeout(() => {
      setOutputText('Converted PDF content will appear here.\n\nConnect this to your PDF conversion backend API.');
      setIsProcessing(false);
    }, 1500);
  };
  ...
  return (
    <div className="tool-container">
      <div className="tool-panel">
        <div className="panel-header">
          <span className="panel-title">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/></svg>
            Upload PDF
          </span>
        </div>
        <label className={`upload-area ${selectedFile ? 'has-file' : ''}`}>
        ...
        <div className="panel-footer">
          <span></span>
          <button className="btn-primary" onClick={handleConvert} disabled={!selectedFile || isProcessing}>
      ...
      <div className="tool-panel">
        ...
        <div className="panel-body">
          <textarea className="tool-textarea" placeholder="Converted text will appear here..." value={outputText} readOnly />
        </div>
        <div className="panel-footer">
          <span className="char-count">{outputText.length} characters</span>
        </div>
